...
QT_MOC_LITERAL(3, 36, 15) // "openSubSubPanel"
    ...
    "FrogPilotVisualsPanel\0openSubPanel\0\0"
    "openSubSubPanel"
};
...
void FrogPilotVisualsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotVisualsPanel::openSubPanel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FrogPilotVisualsPanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotVisualsPanel::openSubSubPanel)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FrogPilotVisualsPanel::openSubPanel()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FrogPilotVisualsPanel::openSubSubPanel()
{
