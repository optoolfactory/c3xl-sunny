...
QT_MOC_LITERAL(2, 34, 0) // ""
    ...
    "FrogPilotThemesPanel\0openSubPanel\0"
};
...
void FrogPilotThemesPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrogPilotThemesPanel::openSubPanel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FrogPilotThemesPanel::openSubPanel()
{
